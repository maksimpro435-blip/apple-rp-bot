...
BACKUP_DIR = "backups"
COUNTRIES_FILE = "countries_s4.json"
PENDING_FILE = "pending_s4.json"
RESOURCES_FILE = "resources_s4.json"
ARCHIVE_FILE = "archive.json"
REVIEWS_FILE = "reviews_s4.json"
USERS_FILE = "users_s4.json"
...
country_counter = {4: 0}
if archive and archive.get("season_4_archived", False):
    season_archived = True
if countries:
    country_counter[4] = max(c.get("number", 0) for c in countries.values())
else:
    country_counter[4] = 0
