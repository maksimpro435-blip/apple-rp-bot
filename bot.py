...
BACKUP_DIR = "backups"
COUNTRIES_FILE = "countries_s5.json"
PENDING_FILE = "pending_s5.json"
RESOURCES_FILE = "resources_s5.json"
ARCHIVE_FILE = "archive.json"
REVIEWS_FILE = "reviews_s5.json"
USERS_FILE = "users_s5.json"
...
country_counter = {5: 0}
if archive and archive.get("season_5_archived", False):
    season_archived = True
if countries:
    country_counter[5] = max(c.get("number", 0) for c in countries.values())
else:
    country_counter[5] = 0
